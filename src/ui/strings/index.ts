const strings = {
	...
	social_maps_alt: 'Logo Maps',

	text_instagram: '@dalupizzariajandira',
	text_internet: 'asoncs.github.io/dalu_pizzaria/',
	text_whatsapp: '(11) 2878-9425',
	text_maps: {
		part1: 'R. Itapiranga, nº 72',
